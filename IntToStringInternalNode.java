...
public class IntToStringInternalNode extends Node {

	private List<Integer> keys;
	private List<Node> child;
	private IntToStringInternalNode next;
	
	private BPlusTreeIntToString60 bplus;

	public IntToStringInternalNode(int size, BPlusTreeIntToString60 bplus){
	...
	public boolean add(int key, Node node){
	...
	public boolean split(IntToStringInternalNode sibling){
	...
	public boolean addKey(int index, int key){
	...
	public boolean setKey(int index, int key){
		if(keys.size()>=index){
			keys.add(index, key);
		}
		else if(keys.size()==0){
